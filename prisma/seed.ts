...
async function main() {
  ...
  const techdeals = await db.user.create({
    data: {
      ...
      phoneVerified: true,
      phoneVerifiedAt: ago(30 * DAY),
      idVerified: true,
      idVerifiedAt: ago(60 * DAY),
      idSubmittedAt: ago(65 * DAY),
  ...
  const outdoorgear = await db.user.create({
    data: {
      ...
      emailVerified: new Date(),
      idVerified: true,
      idVerifiedAt: ago(14 * DAY),
      idSubmittedAt: ago(20 * DAY),
      ...
      stripeChargesEnabled: true,
      stripePayoutsEnabled: true,
      sellerTermsAcceptedAt: ago(30 * DAY),
      onboardingCompleted: true,
      onboardingIntent: "SELL",
      region: "Canterbury",
  ...
  const fashionhub = await db.user.create({
    data: {
      email: "fashionhub@kiwimart.test",
      username: "fashionhub",
      displayName: "FashionHub NZ",
      passwordHash: sellerHash,
      emailVerified: new Date(),
      phoneVerified: true,
      phoneVerifiedAt: ago(15 * DAY),
      bio: "Curated streetwear, designer fashion and sneakers. Authenticity guaranteed. Hamilton-based.",
      sellerEnabled: true,
      stripeOnboarded: true,
      stripeAccountId: "acct_1RTestFashionHubNZ04",
      stripeChargesEnabled: true,
      stripePayoutsEnabled: true,
      sellerTermsAcceptedAt: ago(45 * DAY),
      onboardingCompleted: true,
      onboardingIntent: "SELL",
      region: "Waikato",
  ...
  const carol = await db.user.create({
    data: {
      email: "buyer3@kiwimart.test",
      username: "carol_wgtn",
      displayName: "Carol W",
      passwordHash: buyerHash,
      emailVerified: new Date(),
      phoneVerified: true,
      phoneVerifiedAt: ago(5 * DAY),
      onboardingCompleted: true,
      onboardingIntent: "BOTH",
      region: "Canterbury",
      suburb: "Riccarton",
  ...
  const adminAccounts = [
    ...
    {
      email: "safety@kiwimart.test",
      role: "TRUST_SAFETY_ADMIN",
      name: "Safety Admin",
      username: "safety_admin",
    },
    {
      email: "support@kiwimart.test",
      role: "SUPPORT_ADMIN",
      name: "Support Admin",
      username: "support_admin",
    },
    {
      email: "sellers@kiwimart.test",
      role: "SELLER_MANAGER",
      name: "Seller Manager",
      username: "sellers_admin",
    },
    {
      email: "readonly@kiwimart.test",
  ...
  const iphone = await L(
    {
      ...
      title: "iPhone 15 Pro 256GB — Pristine Condition",
      description:
        "Bought new 3 months ago, upgrading to 15 Pro Max. Phone is in perfect condition, no scratches or marks. Comes with original box, charger, and unused EarPods. Battery health 99%. Face ID working perfectly. Unlocked to all NZ networks.",
      priceNzd: 149900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
  ...
  const macbook = await L(
    {
      sellerId: techdeals.id,
      title: 'MacBook Pro 14" M3 — Price Reduced!',
      description:
        "M3 chip, 16GB RAM, 512GB SSD. Purchased 6 months ago for work, company provided a new one so this is surplus. Excellent condition with minor desk wear on bottom. Comes with MagSafe charger. AppleCare valid until March 2027.",
      priceNzd: 289900,
      previousPriceNzd: 329900,
      priceDroppedAt: ago(1 * DAY),
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "electronics",
  ...
  const headphones = await L(
    {
      sellerId: techdeals.id,
      title: "Sony WH-1000XM5 Noise Cancelling — Barely Used",
      description:
        "World-class noise cancellation, 30-hour battery life. Used only a handful of times. Still has protective film on ear cups. Comes with original case, cables and documentation.",
      priceNzd: 34900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "electronics",
  ...
  const gamingpc = await L(
    {
      sellerId: techdeals.id,
      title: "Custom Gaming PC — Must Sell, Moving to Australia",
      description:
        "RTX 4070, i7-13700K, 32GB DDR5, 1TB NVMe SSD. Built 8 months ago, runs everything at ultra settings. Moving overseas next week. Serious buyers only.",
      priceNzd: 229900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "electronics",
  ...
  const ipad = await L(
    {
      sellerId: techdeals.id,
      title: "iPad Air 5th Gen 64GB WiFi — Open to Offers",
      description:
        "Great condition iPad Air, used mainly for reading and video calls. Screen is perfect with no scratches. Smart Folio case included (worth $120).",
      priceNzd: 64900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "electronics",
  ...
  const tv = await L(
    {
      sellerId: techdeals.id,
      title: 'Samsung 65" QLED 4K Smart TV — Nationwide Delivery',
      description:
        'QN65Q80C, bought 1 year ago. Stunning picture quality with QLED technology. Selling as upgrading to 85". All original remotes and stand included.',
      priceNzd: 189900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "electronics",
      subcategoryName: "TV & Home Theatre",
      region: "Auckland",
      suburb: "Newmarket",
      shippingOption: "BOTH",
      shippingNzd: 15000,
  ...
  const airpods = await L(
    {
      sellerId: techdeals.id,
      title: "AirPods Pro 2nd Gen — Excellent Condition",
      description:
        "Purchased 4 months ago. ANC and Transparency mode working perfectly. Original box included.",
      priceNzd: 28900,
      condition: "LIKE_NEW",
      status: "SOLD",
      categoryId: "electronics",
  ...
  const drone = await L(
    {
      ...
      description:
        "Under 249g, no licence needed in NZ. 4K/60fps video, 48MP photos. Only 3 flights, immaculate. 3 batteries, charging hub, carrying bag.",
      priceNzd: 149900,
      condition: "LIKE_NEW",
      status: "SOLD",
      categoryId: "electronics",
  ...
  const sofa = await L(
    {
      sellerId: homestyle.id,
      title: "Danish Design 3-Seater Sofa — Excellent Condition",
      description:
        "Beautiful mid-century modern sofa in oatmeal fabric. Bought from Freedom Furniture 18 months ago for $2,800. Moving house. No stains, pets or smoke. 220cm W x 90cm D.",
      priceNzd: 119900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
  ...
  const mixer = await L(
    {
      ...
      description:
        "Received as a wedding gift, already had one so barely used. 4.8L bowl, 10 speeds. All original attachments. RRP $999.",
      priceNzd: 59900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "home-garden",
  ...
  const vacuum = await L(
    {
      sellerId: homestyle.id,
      title: "Dyson V15 Detect — Full Accessory Kit",
      description:
        "Dyson V15 with laser dust detection. All attachments, HEPA filtration. 8 months old, battery holds full charge.",
      priceNzd: 59900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "home-garden",
  ...
  const bbq = await L(
    {
      sellerId: homestyle.id,
      title: "Weber Genesis E-325s Gas BBQ — NZ Compatible",
      description:
        "Weber Genesis 3-burner BBQ. GS4 grilling system, iGrill compatible. Used 2 summers, cleaned after each use. Cover included. Wellington pickup.",
      priceNzd: 89900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "home-garden",
      ...
      viewCount: 97,
      watcherCount: 5,
      publishedAt: ago(11 * DAY),
      expiresAt: future(19 * DAY),
    },
  ...
  const diningset = await L(
    {
      sellerId: homestyle.id,
      title: "6-Person Outdoor Dining Set — Aluminium Frame",
      description:
        "Weather-resistant aluminium table (180x90cm) and 6 chairs. Used one summer season, stored indoors over winter. Cushions in excellent condition.",
      priceNzd: 89900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "home-garden",
  ...
  const lamp = await L(
    {
      sellerId: homestyle.id,
      title: "Designer Floor Lamp — Tom Dixon Melt",
      description:
        "Tom Dixon Melt floor lamp in gold. Statement piece. Purchased from ECC Wellington. Perfect working order.",
      priceNzd: 79900,
      condition: "LIKE_NEW",
      status: "SOLD",
      categoryId: "home-garden",
  ...
  const coat = await L(
    {
      ...
      title: "Trenery Wool Blend Winter Coat — Size 12, Camel",
      description:
        "Stunning wool blend coat from Trenery, worn only 3 times. Size 12, fits true to size. Dry cleaned. No damage or pilling. Original price $599.",
      priceNzd: 18900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "fashion",
  ...
  const sneakers = await L(
    {
      ...
      description:
        "Bought for a fun run that got cancelled. Worn twice around the block. Size 10 US / 44 EU. Original box. No marks.",
      priceNzd: 10900,
      previousPriceNzd: 14900,
  ...
  const jordans = await L(
    {
      ...
      description:
        "Deadstock. Never worn. Original box and accessories. StockX authenticated. Impossible to find in NZ.",
      priceNzd: 49900,
      condition: "NEW",
      status: "ACTIVE",
      categoryId: "fashion",
  ...
  const handbag = await L(
    {
      sellerId: fashionhub.id,
      title: "Coach Tabby Shoulder Bag — Black Leather",
      description:
        "Coach Tabby 26 in black. Signature hardware, adjustable strap. Used twice. Dust bag and care card included. RRP $895.",
      priceNzd: 44900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "fashion",
  ...
  const watch = await L(
    {
      sellerId: fashionhub.id,
      title: "Seiko Presage SRPD37J1 — Japanese Automatic",
      description:
        "Seiko Presage cocktail time. 40.5mm case, sapphire crystal, 4R35 movement. Worn 5 times. Box, papers, warranty card.",
      priceNzd: 59900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "fashion",
  ...
  const jacket = await L(
    {
      sellerId: fashionhub.id,
      title: "North Face Thermoball Eco Jacket — Size L",
      description:
        "Recycled ThermoBall insulation. Lightweight, packable, warm. Worn one winter. Like new.",
      priceNzd: 17900,
      condition: "LIKE_NEW",
      status: "SOLD",
      categoryId: "fashion",
  ...
  const mtb = await L(
    {
      ...
      title: "Trek Marlin 7 Mountain Bike 2023 — Medium",
      description:
        '29" wheels, 1x12 drivetrain, hydraulic disc brakes. Ridden about 15 times. Serviced 2 months ago. Minor trail marks but mechanically perfect.',
      priceNzd: 139900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "sports",
  ...
  const tent = await L(
    {
      sellerId: outdoorgear.id,
      title: "MSR Hubba Hubba 2-Person Tent — Moving Sale",
      description:
        "Ultralight 2-person backpacking tent, 1.27kg. Used on 4 overnight trips. All pegs, poles and stuff sacks included. Retail $899.",
      priceNzd: 44900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "sports",
  ...
  const homegym = await L(
    {
      sellerId: outdoorgear.id,
      title: "Home Gym Bundle — Dumbbells, Bench and Bands",
      description:
        "Adjustable dumbbell set (5-32.5kg each), padded weight bench, 5 resistance bands. All high quality, well maintained.",
      priceNzd: 69900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "sports",
      subcategoryName: "Running & Fitness",
      region: "Canterbury",
      suburb: "Christchurch City",
      shippingOption: "PICKUP",
      isNegotiable: true,
  ...
  const kayak = await L(
    {
      sellerId: outdoorgear.id,
      title: "Perception Pescador 12 Sit-on-Top Kayak",
      description:
        "Stable, versatile kayak for lakes, harbours and calm coastal waters. UV-resistant hull. Includes Werner paddle (worth $250). Christchurch pickup.",
      priceNzd: 119900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "sports",
  ...
  const skipack = await L(
    {
      sellerId: outdoorgear.id,
      title: "Complete Ski Package — Skis, Boots, Poles, Bag",
      description:
        "170cm Rossignol Experience 78 skis with Marker bindings, Salomon boots (size 27.5), poles and wheeled ski bag. Used 2 seasons.",
      priceNzd: 89900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "sports",
      subcategoryName: "Snow Sports",
      region: "Canterbury",
      suburb: "Christchurch City",
      shippingOption: "COURIER",
      shippingNzd: 2500,
  ...
  const backpack = await L(
    {
      sellerId: outdoorgear.id,
      title: "Macpac Cascade 65L Tramping Pack",
      description:
        "Macpac Cascade 65L in forest green. Used on 4 multi-day trips. Adjustable harness, hipbelt pockets. Perfect for Routeburn track.",
      priceNzd: 18900,
      condition: "GOOD",
      status: "SOLD",
      categoryId: "sports",
  ...
  const drill = await L(
    {
      sellerId: outdoorgear.id,
      title: "DeWalt 18V XR Brushless Drill Kit — 2 Batteries",
      description:
        "DCD796 drill and DCF887 impact driver combo. 2x 5Ah batteries and dual charger. Used for one renovation project. Full TSTAK case.",
      priceNzd: 47900,
      condition: "LIKE_NEW",
      status: "ACTIVE",
      categoryId: "business",
  ...
  await L(
    {
      sellerId: outdoorgear.id,
      title: "Bosch 12V Professional Hand Tool Set",
      description:
        "Bosch Professional 12V system. Drill, impact driver, circular saw. 3 batteries, charger, bag. Compact and powerful.",
      priceNzd: 39900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "business",
  ...
  await L(
    {
      ...
      description:
        "The iconic office chair. PostureFit SL, fully adjustable arms, tilt limiter. 2 years old, perfect condition. RRP $2,400+.",
      priceNzd: 129900,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "business",
  ...
  await L(
    {
      sellerId: homestyle.id,
      title: "Bugaboo Fox 3 Pram — Midnight Black",
      description:
        "Bugaboo Fox 3 complete. Bassinet, seat, rain cover, mosquito net. Used for 8 months. Excellent condition. RRP $2,200.",
      priceNzd: 109900,
      condition: "GOOD",
      status: "ACTIVE",
  ...
  await L(
    {
      sellerId: fashionhub.id,
      title: "LEGO Technic Porsche 911 GT3 RS — Sealed",
      description:
        "LEGO set 42056. Factory sealed, never opened. Discontinued set, collector item. Perfect gift.",
      priceNzd: 69900,
      condition: "NEW",
      status: "ACTIVE",
      categoryId: "baby-kids",
  ...
  await L(
    {
      sellerId: fashionhub.id,
      title: "Signed All Blacks Jersey — 2023 World Cup Squad",
      description:
        "Framed All Blacks jersey signed by the 2023 Rugby World Cup squad. Certificate of authenticity from NZRU. Perfect condition.",
      priceNzd: 149900,
      condition: "NEW",
      status: "ACTIVE",
  ...
  await L(
    {
      sellerId: homestyle.id,
      title: "Original NZ Landscape Oil Painting — Milford Sound",
      description:
        "Original oil on canvas by Wellington artist. 90cm x 60cm, framed. Beautiful representation of Milford Sound at dawn.",
      priceNzd: 89900,
      condition: "NEW",
      status: "ACTIVE",
      categoryId: "collectibles",
  ...
  await L(
    {
      sellerId: homestyle.id,
      title: "Room Available — Kelburn Flat, 5 Min to Vic Uni",
      description:
        "1 room in a 3-bedroom flat. Sunny, warm, insulated. $250/week incl. water and internet. Available from April 1.",
      priceNzd: 25000,
      condition: "GOOD",
      status: "ACTIVE",
      categoryId: "property",
      subcategoryName: "Flatmates",
      region: "Wellington",
      suburb: "Kelburn",
      shippingOption: "PICKUP",
      viewCount: 345,
  ...
  const order2 = await db.order.create({
    data: {
      ...
      stripeTransferId: "tr_test_seed_002",
      shippingName: "Ben T",
      shippingLine1: "15 Cuba Street",
  ...
  const order3 = await db.order.create({
    data: {
      ...
      stripeTransferId: "tr_test_seed_003",
      shippingName: "Carol W",
  ...
  const order4 = await db.order.create({
    data: {
      ...
      stripeTransferId: "tr_test_seed_004",
      shippingName: "Alice M",
      shippingLine1: "42 Ponsonby Road",
      shippingCity: "Auckland",
      shippingRegion: "Auckland",
  ...
  const order5 = await db.order.create({
    data: {
      ...
      deliveredAt: ago(13 * DAY),
      disputeReason: "ITEM_NOT_AS_DESCRIBED",
      disputeOpenedAt: ago(12 * DAY),
      disputeNotes:
        "Multiple tears on the shoulder straps that were not mentioned in the listing. The hip belt buckle is also broken.",
  ...
  const order6 = await db.order.create({
    data: {
      buyerId: carol.id,
      sellerId: techdeals.id,
      listingId: airpods, // reuse listing for variety
      itemNzd: 28900,
      shippingNzd: 0,
      totalNzd: 28900,
      status: "DISPUTED",
      ...
      disputeOpenedAt: ago(2 * DAY),
      disputeNotes:
        "Tracking shows delivered but I never received the package. My building has secure mailboxes.",
      createdAt: ago(8 * DAY),
    },
  });
  ...
  await db.order.create({
    data: {
      ...
      trackingUrl: "https://www.nzpost.co.nz/track",
  ...
  console.log(
    "✅ 11 orders created (4 completed, 2 disputed, 2 dispatched, 2 payment held, 1 awaiting)",
  );
  ...
  await db.review.create({
    data: {
      ...
      rating: 50,
      comment:
        "Fast shipping, item exactly as described. Great seller, would buy again!",
      approved: true,
      createdAt: ago(2 * DAY),
    },
  });
  ...
  await db.review.create({
    data: {
      ...
      rating: 45,
      comment:
        "Drone is amazing. Well packaged, arrived quickly. Minor scuff on case but drone itself is perfect.",
      sellerReply:
        "Thanks Ben! Sorry about the case — happy to send a replacement if you want.",
  ...
  await db.review.create({
    data: {
      ...
      rating: 50,
      comment:
        "Stunning lamp! Even more beautiful in person. Carefully packed, arrived safely despite shipping.",
      approved: true,
      createdAt: ago(7 * DAY),
    },
  });
  ...
  await db.review.create({
    data: {
      ...
      rating: 40,
      comment:
        "Jacket is warm and good quality. Took a couple extra days to ship but overall happy with the purchase.",
      approved: true,
      createdAt: ago(6 * DAY),
    },
  });
  ...
  for (const [order, seller, amount] of [
    ...
    await db.payout.create({
      data: {
        orderId: order.id,
        userId: seller.id,
        amountNzd: Number(amount) - fee,
        platformFeeNzd: 0,
        stripeFeeNzd: fee,
        status: "PAID",
        stripeTransferId: `tr_payout_${order.id.slice(-6)}`,
        initiatedAt: ago(3 * DAY),
        paidAt: ago(2 * DAY),
        createdAt: ago(3 * DAY),
      },
    });
  ...
  await db.offer.create({
    data: {
      ...
      sellerId: techdeals.id,
      amountNzd: 260000,
      note: "Would you take $2,600? Can pick up today from Newmarket.",
      status: "PENDING",
  ...
  await db.offer.create({
    data: {
      ...
      sellerId: homestyle.id,
      amountNzd: 100000,
      note: "Would you accept $1,000? Can pick up this weekend.",
      status: "ACCEPTED",
      expiresAt: ago(1 * DAY),
  ...
  await db.offer.create({
    data: {
      ...
      sellerId: techdeals.id,
      amountNzd: 180000,
      note: "How about $1,800?",
      status: "DECLINED",
      expiresAt: ago(1 * DAY),
      respondedAt: ago(2 * DAY),
      declineNote: "Sorry, lowest I can go is $2,100. It is a premium build.",
      createdAt: ago(3 * DAY),
    },
  });
  ...
  await db.offer.create({
    data: {
      ...
      sellerId: outdoorgear.id,
      amountNzd: 120000,
      note: "Would you do $1,200? I can pick up from Chch this weekend.",
      status: "PENDING",
      expiresAt: future(2 * DAY),
  ...
  console.log(
    "✅ 5 offers created (2 pending, 1 accepted, 1 declined, 1 expired)",
  );
  ...
  await db.report.create({
    data: {
      reporterId: alice.id,
      targetUserId: outdoorgear.id,
      listingId: backpack,
      reason: "SCAM",
      description:
        'Seller listed the backpack as "good condition" but it arrived with significant damage to the shoulder straps and a broken buckle. Photos in dispute.',
      status: "OPEN",
      createdAt: ago(12 * DAY),
    },
  });
  ...
  await db.report.create({
    data: {
      ...
      reason: "COUNTERFEIT",
      description:
        "These Jordans look suspicious. The stitching pattern does not match authentic pairs and the box label font is wrong. Might be replicas.",
      status: "REVIEWING",
      createdAt: ago(5 * DAY),
    },
  });
  ...
  await db.report.create({
    data: {
      reporterId: carol.id,
      targetUserId: fashionhub.id,
      reason: "SPAM",
      description:
        "This seller has listed the same jacket in 3 different categories with slightly different titles. Seems like spam to boost visibility.",
      status: "DISMISSED",
      resolvedAt: ago(2 * DAY),
      resolvedNote:
        "Seller has been warned about duplicate listings. No further action needed.",
      createdAt: ago(7 * DAY),
    },
  });
  ...
  const notifications = [
    // Alice
    {
      ...
      body: "Your order for AirPods Pro 2nd Gen has been confirmed.",
    ...
    },
    {
      ...
      body: "Your AirPods Pro order has been completed. Payment released to seller.",
      link: "/dashboard/buyer",
      orderId: order1.id,
      read: true,
    },
    {
      ...
      title: "New message from TechDeals NZ",
      body: "Hi Alice! Yes still available. I can do $2,750...",
    ...
    },
    {
      ...
      body: 'Your offer of $2,600 for MacBook Pro 14" M3 is pending.',
      link: "/dashboard/buyer",
      listingId: macbook,
    },
    {
      ...
      body: '"MacBook Pro 14" M3" dropped from $3,299 to $2,899',
    ...
    // Ben
    {
      ...
      type: "ORDER_PLACED",
      title: "Order confirmed",
      body: "Your order for DJI Mini 4 Pro has been confirmed.",
      link: "/dashboard/buyer",
      orderId: order2.id,
      read: true,
    },
    {
      ...
      body: "Your offer of $1,800 for Gaming PC was declined.",
      link: "/dashboard/buyer",
      listingId: gamingpc,
      read: true,
    },
    {
      ...
      body: "Your dispute for the Macpac Cascade backpack is being reviewed.",
      link: "/dashboard/buyer",
      orderId: order5.id,
    },
    // Carol
    {
      ...
      type: "ORDER_COMPLETED",
      title: "Order completed",
      body: "Your Designer Floor Lamp order has been completed.",
      link: "/dashboard/buyer",
      orderId: order3.id,
      read: true,
    },
    {
      ...
      body: "Your offer of $1,000 for the Danish sofa was accepted!",
      link: "/dashboard/buyer",
      listingId: sofa,
    },
    // TechDeals
    {
      ...
      body: 'Alice M offered $2,600 for your MacBook Pro 14" M3.',
    ...
    },
    {
      ...
      type: "ORDER_PLACED",
      title: "New sale!",
      body: "You sold AirPods Pro 2nd Gen for $289.",
      link: "/dashboard/seller",
      orderId: order1.id,
      read: true,
    },
    {
      ...
      body: "Alice M left a 5-star review on your AirPods sale.",
      link: "/dashboard/seller",
      read: true,
    },
    // HomeStyle
    {
      ...
      type: "ORDER_PLACED",
      title: "New sale!",
      body: "You sold Designer Floor Lamp for $799.",
      link: "/dashboard/seller",
      orderId: order3.id,
      read: true,
    },
    {
      ...
      type: "OFFER_RECEIVED",
      title: "New offer received",
      body: "Carol W offered $1,000 for your Danish Sofa.",
      link: "/dashboard/seller",
      listingId: sofa,
    },
    // OutdoorGear
    {
      userId: outdoorgear.id,
      type: "DISPUTE_OPENED",
      title: "Dispute opened on your sale",
      body: "Ben T opened a dispute on the Macpac Cascade backpack order.",
      link: "/dashboard/seller",
      orderId: order5.id,
    },
    {
      ...
      type: "OFFER_RECEIVED",
      title: "New offer received",
      body: "Alice M offered $1,200 for your Trek Marlin 7.",
      link: "/dashboard/seller",
      listingId: mtb,
    },
  ];
  ...
  for (const n of notifications) {
    await db.notification.create({
      data: {
        ...
        orderId: n.orderId,
        read: n.read ?? false,
        createdAt: ago(Math.random() * 7 * DAY),
      },
    });
  }
  ...
  const auditEntries = [
    ...
    {
      userId: techdeals.id,
      action: "ID_VERIFICATION_SUBMITTED" as const,
      createdAt: ago(65 * DAY),
    },
    {
      userId: techdeals.id,
      action: "ID_VERIFICATION_APPROVED" as const,
