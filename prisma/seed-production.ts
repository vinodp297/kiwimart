...
async function main() {
  ...
  const listings: LD[] = [
    ...
    {
      t: "2019 Toyota Corolla Hybrid Silver 38K",
      p: 26990,
      c: "GOOD",
      s: "ChchCycles",
      cat: "vehicles",
      ...
      sp: null,
      o: true,
      im: "photo-1617654112329-a2b8a38c4c7e",
      d1: "2019 Toyota Corolla Hybrid ZR hatch in Silver Pearl. Only 38,000km, full Toyota service history. Adaptive cruise, lane keep assist, reversing camera. Excellent fuel economy.",
      a: [
        ["Make", "Toyota"],
        ["Model", "Corolla Hybrid ZR"],
        ["Year", "2019"],
        ["Odometer", "38,000 km"],
        ["Fuel", "Hybrid"],
      ],
    ...
    {
      t: "2020 Mazda 3 Hatch 2.0L 28K Black",
      p: 24500,
      c: "GOOD",
      s: "ChchCycles",
      cat: "vehicles",
      ...
      sp: null,
      o: true,
      im: fallback("vehicles"),
      d1: "2020 Mazda 3 GSX hatchback in Machine Grey Metallic. 2.0L SkyActiv-G, 28,000km. Bose sound system, heads-up display, adaptive cruise. Beautiful to drive.",
      a: [
        ["Make", "Mazda"],
        ["Model", "3 GSX Hatch"],
        ["Year", "2020"],
    ...
    {
      t: "2018 Honda Civic Sport 1.5T 45K Blue",
      p: 18990,
      c: "GOOD",
      s: "SpinningWellie",
      cat: "vehicles",
      ...
      o: true,
      im: fallback("vehicles"),
      d1: "2018 Honda Civic Sport 1.5 VTEC Turbo hatch in Aegean Blue. 45,000km, full dealer service history. CarPlay/Android Auto, Honda Sensing suite. Fun daily driver.",
      a: [
        ["Make", "Honda"],
        ["Model", "Civic Sport 1.5T"],
        ["Year", "2018"],
        ["Odometer", "45,000 km"],
        ["Colour", "Aegean Blue"],
      ],
    ...
    {
      t: "2021 Toyota RAV4 Hybrid AWD 22K White",
      p: 38500,
      c: "LIKE_NEW",
      s: "HomeGoodsNZ",
      cat: "vehicles",
      ...
      o: true,
      im: fallback("vehicles"),
      d1: "2021 Toyota RAV4 GXL Hybrid e-Four AWD in Crystal Pearl White. Only 22,000km. Full Toyota warranty remaining. Safety Sense 2.0, 8-inch display, wireless charging.",
      a: [
        ["Make", "Toyota"],
        ["Model", "RAV4 GXL Hybrid AWD"],
        ["Year", "2021"],
        ["Odometer", "22,000 km"],
        ["Colour", "Crystal Pearl White"],
      ],
    },
    {
      t: "2017 Subaru Forester XT 2.0T 68K Silver",
      p: 16500,
      c: "GOOD",
      s: "ChchCycles",
      cat: "vehicles",
      ...
      o: true,
      im: fallback("vehicles"),
      d1: "2017 Subaru Forester XT Premium in Ice Silver. 2.0L turbo boxer, 68,000km, symmetrical AWD. EyeSight driver assist, X-Mode. Great family SUV for NZ roads.",
      a: [
        ["Make", "Subaru"],
        ["Model", "Forester XT Premium"],
        ["Year", "2017"],
        ["Odometer", "68,000 km"],
        ["Engine", "2.0L Turbo"],
      ],
    ...
    {
      t: "Giant Escape 3 City Bike M 2024",
      p: 480,
      c: "LIKE_NEW",
      s: "ChchCycles",
      cat: "vehicles",
      ...
      o: false,
      im: fallback("vehicles"),
      d1: "Giant Escape 3 Disc flat-bar road bike in metallic navy, size medium. ALUXX aluminium frame, Shimano 8-speed, mechanical disc brakes. Ridden less than 100km.",
      a: [
        ["Brand", "Giant"],
        ["Model", "Escape 3 Disc"],
        ["Size", "Medium"],
    ...
    {
      t: "Trek Marlin 7 MTB 29er L 2023",
      p: 890,
      c: "GOOD",
      s: "ChchCycles",
      cat: "vehicles",
      ...
      o: true,
      im: fallback("vehicles"),
      d1: "Trek Marlin 7 hardtail mountain bike in Matte Nautical Navy, size large. 29-inch wheels, RockShox Judy fork, Shimano Deore 10-speed. Great trail bike for Canterbury.",
      a: [
        ["Brand", "Trek"],
        ["Model", "Marlin 7"],
        ["Size", "Large"],
    ...
    {
      t: "Segway Ninebot G30 MAX E-Scooter",
      p: 680,
      c: "GOOD",
      s: "HomeGoodsNZ",
      cat: "vehicles",
      ...
      o: true,
      im: fallback("vehicles"),
      d1: "Segway Ninebot KickScooter MAX G30. 65km range, 25km/h max speed, 10-inch pneumatic tyres. IPX5 water resistant. The best commuter e-scooter. 800km on odometer.",
      a: [
    ...
    {
      t: "2016 Toyota Hilux SR5 4x4 Auto 95K",
      p: 28900,
      c: "GOOD",
      s: "HomeGoodsNZ",
      cat: "vehicles",
      ...
      o: true,
      im: fallback("vehicles"),
      d1: "2016 Toyota Hilux SR5 double cab 4WD in Graphite. 2.8L turbo diesel, 6-speed auto, 95,000km. Tow bar, sports bar, tonneau cover. The ultimate NZ workhorse.",
      a: [
        ["Make", "Toyota"],
        ["Model", "Hilux SR5 4x4"],
        ["Year", "2016"],
    ...
    {
      t: "Boat Trailer Galvanised Suits 5m",
      p: 1850,
      c: "GOOD",
      s: "NorthlandFinds",
      cat: "vehicles",
      ...
      o: true,
      im: fallback("vehicles"),
      d1: "Galvanised boat trailer suitable for boats up to 5 metres. Multi-roller setup, winch included. WOF current. Good condition, recently re-greased bearings. Pickup Whangarei.",
      a: [
        ["Type", "Multi-roller"],
        ["Suits", "Boats up to 5m"],
