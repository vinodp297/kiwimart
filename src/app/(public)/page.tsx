...
export default async function HomePage() {
  const { listingCount, memberCount, featuredListings, categoryCounts } =
  ...
  const FEATURED = featuredListings
    ? featuredListings.map((row) => ({
        ...
        condition: (CONDITION_MAP[row.condition] ?? "good") as
          | "new"
          | "like-new"
          | "good"
          | "fair"
        ...
        shippingOption: row.shippingOption.toLowerCase() as
          | "courier"
          | "pickup"
          | "both",
          ...
          >
            <div>
              ...
              <p className="mt-2 text-[14px] text-white/60 max-w-md">
                List your item in under 2 minutes. $0 listing fee. Secure
                payment straight to your bank once the buyer confirms receipt.
              </p>
            </div>
            <Link
              href="/sell"
