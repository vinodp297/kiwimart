    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl border border-[#E3E0D9] p-8 max-w-md w-full text-center">
          ...
          <h1 className="font-semibold text-[20px] text-[#141414] mb-2">Report submitted</h1>
          <p className="text-[#73706A] text-[14px] mb-6 leading-relaxed">
            Thank you for helping keep KiwiMart safe. Our moderation team will review this report within 24 hours.
          </p>
          <a
            href="/"
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await createReport({
        listingId,
        targetUserId,
        reason: reason as 'SCAM' | 'COUNTERFEIT' | 'PROHIBITED' | 'OFFENSIVE' | 'SPAM' | 'OTHER',
    ...
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-[#E3E0D9] p-8 max-w-lg w-full">
        ...
        <div className="space-y-3 mb-6">
          <p className="text-[13px] font-semibold text-[#141414]">What is the issue?</p>
          {REPORT_REASONS.map((r) => (
            ...
            >
              ...
              />
              <div>
                <p className="font-medium text-[13px] text-[#141414]">{r.label}</p>
        ...
        <div className="mb-6">
          ...
          />
          <p className="text-[11px] text-[#C9C5BC] mt-1">{description.length}/2000 characters</p>
        </div>
