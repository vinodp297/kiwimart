...
const CONTACT_CARDS = [
  {
    ...
    description: 'For general questions about KiwiMart',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D4A843" strokeWidth="1.8">
        ...
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="mb-12">
            ...
            <p className="text-[16px] text-[#73706A] leading-relaxed">
              We are here to help. Reach out to the KiwiMart team.
            </p>
          </div>
            ...
            {CONTACT_CARDS.map(({ icon, title, email, description }) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[12.5px] text-[#73706A] mb-2">{description}</p>
                  <a
                    href={`mailto:${email}`}
