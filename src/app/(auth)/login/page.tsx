      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-white rounded-2xl border border-[#E3E0D9] shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-[12px] text-[#D4A843] hover:text-[#B8912E] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <Input
                ...
                rightAddon={
                  <button type="button" onClick={() => setShowPw((v) => !v)} aria-label={showPw ? 'Hide password' : 'Show password'} className="hover:text-[#141414] transition-colors">
                    {showPw
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className="w-4 h-4 rounded border-[#C9C5BC] accent-[#D4A843] cursor-pointer" />
          ...
          <p className="mt-6 text-center text-[13px] text-[#73706A]">
            ...
            <Link href="/register" className="font-semibold text-[#D4A843] hover:text-[#B8912E] transition-colors">Register free</Link>
          </p>
        </div>

        <p className="mt-5 text-center text-[11.5px] text-[#C9C5BC]">
          Protected by KiwiMart&apos;s secure sign-in. By signing in you agree to our{' '}
          <Link href="/terms" className="underline hover:text-[#73706A] transition-colors">Terms of Service</Link>.
        </p>
      </div>
    </main>
  );
