...
export default function ModerationActions({ reportId, hasListing, hasTargetUser, targetAlreadyBanned, unbanUserId }: Props) {
  ...
  if (done) return <span className="text-[11px] text-emerald-600 font-semibold">✓ Done</span>;
