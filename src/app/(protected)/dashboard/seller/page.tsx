      ...
      <main className="bg-[#FAFAF8] min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          ...
          {stripeOnboarded === false && (
            <div
              className="bg-[#141414] text-white rounded-2xl p-6 mb-6 flex
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-6 mt-4">
                  {[
                    ...
                    {
                      value:
                        stats.totalSales >= 5 ? `${stats.responseRate}%` : "—",
                      label:
                        stats.totalSales >= 5 ? "Response rate" : "New seller",
                    },
          ...
          {activeTab === "payouts" && (
            <div role="tabpanel" aria-label="Payouts" className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  ...
                  >
                    ...
                    <p className="text-[12.5px] text-[#9E9A91] mt-1.5">
                      {label}
                    </p>
                  </div>
                ))}
              ...
              <Alert variant="info">
                Payouts are released 3 business days after the buyer confirms
                delivery. Funds arrive in your linked NZ bank account via
                Stripe.
              </Alert>
              ...
              <div className="text-center">
                <p className="text-[12px] text-[#9E9A91]">
                  ...
                  <strong className="text-[#141414]">Stripe Connect</strong>.
                  Need help?{" "}
                  <Link
                    href="/support"
