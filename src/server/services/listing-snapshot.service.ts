// src/server/services/listing-snapshot.service.ts
...
// Prisma passes a constrained client into $transaction callbacks that omits the
// top-level transaction/lifecycle methods. Match that shape here so callers can
// pass the tx argument with full type safety.
